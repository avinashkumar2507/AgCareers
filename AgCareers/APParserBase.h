...
@protocol APParserBaseDelegate <NSObject>
...
@interface APParserBase : NSObject<NSXMLParserDelegate,NSURLConnectionDataDelegate,APParserBaseDelegate>{
    ...
    id <APParserBaseDelegate>delegate;
...
@property (strong,nonatomic) id <APParserBaseDelegate>delegate;
