...
@synthesize delegateRegion,stringCoutnryId,tableViewRegion;
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ((internateStatus != ReachableViaWiFi) && (internateStatus != ReachableViaWWAN)){
        ...
        [delegateRegion sendRegionDictionary:dataDictionary];
        [self.navigationController popViewControllerAnimated:YES];
    }
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    static NSString *kCellID = @"cellRegion";
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kCellID];
    UILabel *newLabel = (UILabel *)[cell viewWithTag:3476];
...
-(void)callWebServiceRegion {
    ...
    NSDictionary* parameterDict = [NSDictionary dictionaryWithObjectsAndKeys: stringCoutnryId,@"countryid",nil];
