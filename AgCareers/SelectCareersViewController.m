...
@interface SelectCareersViewController ()
@property (nonatomic, strong) NSMutableArray *dataArray;
@end

@implementation SelectCareersViewController
@synthesize buttonDone,buttonCancel,tableViewCareer;
@synthesize delegateCareers;
...
- (void)viewDidLoad {
    ...
    [self callWebService];
    [tableViewCareer setEditing:YES animated:YES];
...
- (IBAction)buttonActionDone:(id)sender {
    NSArray *selectedRows = [tableViewCareer indexPathsForSelectedRows];
    ...
    if ([self.tabBarController selectedIndex]==1) {
        ...
        [delegateCareers sendCareersDictionary:dataDictionary ];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure a cell to show the corresponding string from the array.
    if ([self.tabBarController selectedIndex]==1) {
        static NSString *kCellID = @"careerCellId";
        UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kCellID];
        UILabel *newLabel = (UILabel *)[cell viewWithTag:3473];
